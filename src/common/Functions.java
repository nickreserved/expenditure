...
public class Functions {
	...
	public static String saveable(String key, Object value) {
	...
	static public int findEndOfRegex(String s, int start, String regex) {
	...
	static public int getStringClosePosition(String s, int start) {
