...
public class MainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (ac == "about") JOptionPane.showMessageDialog(this, "<html><center><b><font size=4>Στρατιωτικές Δαπάνες</font><br><font size=3>Έκδοση 1.4.3</font></b></center><br>Προγραμματισμός: <b>Υπλγος(ΜΧ) Γκέσος Παύλος</b><br>’δεια χρήσης: <b>BSD</b><br>Δημοσίευση: <b>15 Απρ 2006</b><br>Σελίδα: <b>http://tassadar.physics.auth.gr/~chameleon/programs/?program=cost</b>", getTitle(), JOptionPane.PLAIN_MESSAGE);
	}
