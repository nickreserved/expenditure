...
public class MainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (ac == "about") JOptionPane.showMessageDialog(this, "<html><center><b><font size=4>Στρατιωτικές Δαπάνες</font><br><font size=3>Έκδοση 1.3.0 alpha</font></b></center><br>Προγραμματισμός: <b>Υπλγος(ΜΧ) Γκέσος Παύλος</b><br>’δεια χρήσης: <b>GNU GPL</b><br>Δημοσίευση: <b>12 Δεκ 2005</b><br>Σελίδα: <b>http://tassadar.physics.auth.gr/~chameleon/programs/cost/</b>", getTitle(), JOptionPane.PLAIN_MESSAGE);
	}
