...
public class MainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (ac.equals("Περί...")) JOptionPane.showMessageDialog(this, "<html><center><b><font size=4>Στρατιωτικές Δαπάνες</font><br><font size=3>Έκδοση 1.6.1</font></b></center><br>Προγραμματισμός: <b>Γκέσος Παύλος (ΣΣΕ 2002)</b><br>’δεια χρήσης: <b>BSD</b><br>Δημοσίευση: <b>09 Σεπ 14</b><br>Σελίδα: <b>http://sourceforge.net/projects/ha-expenditure/</b><br><br><center><font size=4>Το Πρόγραμμα έκλεισε 10 Έτη!!!</font></center>", getTitle(), JOptionPane.PLAIN_MESSAGE);
