...
public class MainFrame extends JFrame implements ActionListener {
	...
	public MainFrame() {
		super("Στρατιωτικές Δαπάνες 1.4.5");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (ac == "about") JOptionPane.showMessageDialog(this, "<html><center><b><font size=4>Στρατιωτικές Δαπάνες</font><br><font size=3>Έκδοση 1.4.5</font></b></center><br>Προγραμματισμός: <b>Υπλγος(ΜΧ) Γκέσος Παύλος</b><br>’δεια χρήσης: <b>BSD</b><br>Δημοσίευση: <b>11 Οκτ 2008</b><br>Σελίδα: <b>http://programs.agiasofia.gr/?program=cost</b>", getTitle(), JOptionPane.PLAIN_MESSAGE);
	}
