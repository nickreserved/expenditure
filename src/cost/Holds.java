...
public class Holds extends JPanel implements DataTransmitter {
	...
	public Holds() {
		...
		add(new JScrollPane(new ResizableTable(new ResizableTableModel(this, new String[] { "ÌÔÓ", "ÅÌĞ", "ÔÓÌÅÄÅ", "ÁÏÏÁ", "ÔĞÅÄÅ", "ÅÊÏÅÌÓ", "ÂÁÌ", "×áñôüóçìï", "ÏÃÁ", "Óıíïëï" }, null, Hold.class), false, true)));
	}
