...
final public class CostData extends JPanel implements DataTransmitter {
	...
	public CostData(ItemListener il) {
		...
		add(PropertiesTable.getScrolled(
				...
				new String[] { "<html><b>ΚΟΙΝΕΣ ΔΑΠΑΝΕΣ", "Τύπος Δαπάνης", "Διαγωνισμός", "Δγη διάθεσης", "Δγη συγκρότησης επιτροπών",
						null, null, null, null, "<html>Τίτλος <font color=gray size=2>(αιτιατική)", "Ημερομηνία υποβολής", "Αξκος Έργου",
						...
						null, "<html><b>ΔΑΠΑΝΕΣ ΕΡΓΩΝ", "<html>Έργο <font color=gray size=2>(αιτιατική)", "<html>Περιοχή Έργου <font color=gray size=2>(αιτιατική με άρθρο)",
						"Εργολάβος ή Εργατοτεχνίτης", "Ημερομηνία Ελέγχ. Αφαν. Εργασιών", "Ημερομηνία Οριστ. Επιμέτρησης",
						"Ημερομηνία Προσ. Οριστ. Παραλαβής", "Ημερομηνία Δοικητ. Παράδοσης", "Πρόεδρος Αφανών Εργασιών", "Μέλος Αφανών Εργασιών",
						"Πρόεδρος Προσ. Οριστ. Παραλαβής", "Α' Μέλος Προσ. Οριστ. Παραλαβής",	"Β' Μέλος Προσ. Οριστ. Παραλαβής",
						null, "<html><b>ΔΙΑΓΩΝΙΣΜΟΙ", "Δγη Διακύρηξης Διαγωνισμού", "Δγη Κατακύρωσης Διαγωνισμού", "<html>Εφημερίδες <font color=gray size=2>(χωρίζουν με '<b>,</b>')",
						"<html>Ημερομηνίες Δημοσίευσης <font color=gray size=2>(χωρίζουν με '<b>,</b>')", "<html>Θέμα Διαγωνισμού <font color=gray size=2>(αιτιατική)",
						"Ώρα/Ημερομηνία",	"<html>Τόπος που θα διεξαχθεί <font color=gray size=2>(αιτιατική με άρθρο)", null,
