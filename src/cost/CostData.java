	...
	public CostData(ItemListener il) {
		...
		add(PropertiesTable.getScrolled(
				...
				new String[] { "<html><b>ΚΟΙΝΕΣ ΔΑΠΑΝΕΣ", "Τύπος Δαπάνης", "Διαγωνισμός", "Δγη διάθεσης", "Δγη συγκρότησης επιτροπών",
						...
						null, "<html><b>ΔΙΑΓΩΝΙΣΜΟΙ", "Δγη Συγκρ. Επ. Διενέργ. Διαγωνισμού", "Δγη Διακύρηξης Διαγωνισμού",
						"Δγη Κατακύρωσης Διαγωνισμού", "<html>Εφημερίδες <font color=gray size=2>(χωρίζουν με '<b>,</b>')",
