...
public class Greater extends Function {
  public void setVector(List l) {
    if (l.size() != 2) throw new CompileException(getLine(), "function <b>Greater</b> must take 2 parameters");
    v = l;
  }
  public Object run(RuntimeEnvironment r) {
    ...
    throw new ExecuteException("CastingError", "<b>Greater:</b> Cannot compare <b>" + a + "</b> & <b>" + b + "</b>", getLine());
  }
  ...
  public Object simplify(RuntimeEnvironment r) {
    ...
    else throw new CompileException(getLine(), "<b>Greater</b> has a non-comparable parameter (<b>" + b + "</b>)");
    if (a instanceof Throw) return a;
    else if (a instanceof Comparable || a instanceof Function) v.set(0, a);
    else throw new CompileException(getLine(), "<b>Greater</b> has a non-comparable parameter (<b>" + a + "</b>)");
    if (a instanceof Comparable && b instanceof Comparable)
      return new Boolean (((Comparable) a).compareTo(b) > 0 ? true : false);
    return this;
  }
