...
public class Lshift extends Function {
  public void setVector(List l) {
    if (l.size() != 2) throw new CompileException(getLine(), "function <b>Lshift</b> must take 2 parameters");
    v = l;
  }
  public Object run(RuntimeEnvironment r) {
    ...
    throw new ExecuteException("CastingError", "<b>Lshift</b> has a non-number parameter", getLine());
  }
  ...
  public Object simplify(RuntimeEnvironment r) {
    ...
    else throw new CompileException(getLine(), "<b>Lshift</b> has a non-number parameter (<b>" + b + "</b>)");
    if (a instanceof Throw) return a;
    else if (a instanceof Number || a instanceof Function) v.set(0, a);
    else throw new CompileException(getLine(), "<b>Lshift</b> has a non-number parameter (<b>" + a + "</b>)");
    if (a instanceof Number && b instanceof Number)
      return new Long(((Number) a).longValue() << ((Number) b).longValue());
    return this;
  }
