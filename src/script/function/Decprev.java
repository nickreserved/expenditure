...
public class Decprev extends Function {
  public void setVector(List l) {
    if (l.size() != 1 || !(l.get(0) instanceof Get))
      throw new CompileException(getLine(), "function <b>Decprev</b> must take a <b>Get</b> parameter");
    v = l;
  }
  ...
  public Object run(RuntimeEnvironment r) {
    ...
    throw new ExecuteException("CastingError", "Cannot apply <b>Decprev</b> to <b>" + v.get(0) + "</b> because not a Number.", getLine());
  }
