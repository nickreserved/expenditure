...
public class Sub extends Function {
  public void setVector(List l) {
    if (l.size() != 2) throw new CompileException(getLine(), "function <b>Sub</b> must take 2 parameters");
    v = l;
  }
  public Object run(RuntimeEnvironment r) {
    ...
    if (a instanceof Number && b instanceof Number) return common.M.sub((Number) a, (Number) b);
    throw new ExecuteException("CastingError", "<b>Sub</b> has a non-number parameter", getLine());
  }
  ...
  public Object simplify(RuntimeEnvironment r) {
    ...
    else throw new CompileException(getLine(), "<b>Div</b> has a non-number parameter (<b>" + b + "</b>)");
    if (a instanceof Throw) return a;
    else if (a instanceof Number || a instanceof Function) v.set(0, a);
    else throw new CompileException(getLine(), "<b>Div</b> has a non-number parameter (<b>" + a + "</b>)");
    if (a instanceof Number && b instanceof Number) return common.M.sub((Number) a, (Number) b);
    return this;
  }
