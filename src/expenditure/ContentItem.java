...
final class ContentItem implements VariableSerializable, TableRecord {
	...
	static private ContentItem[] createDefaultContents(Expenditure e) {
		...
		return ΑπευθείαςΑνάθεσηΧωρίςΣύμβαση;
	}

		// Ορισμένα έντυπα δεν καταχωρούνται στο ΦΚ


		static private final ContentItem[] ΑπευθείαςΑνάθεσηΧωρίςΣύμβαση = {
			ΔιαβιβαστικόΔαπάνης,
			ΕξώφυλλοΔαπάνης,
			ΦύλλοΚαταχώρησης,
			Υποφάκελος,
			...
			Τιμολόγια,
			ΔελτίαΑποστολής,
			ΠρωτόκολλοΟριστικήςΠοιοτικήςΠοσοτικήςΠαραλαβής,
			ΒεβαίωσηΠαραλαβής,
			ΑΔΔΥ,
...
//		static private final Paper[] papers = {		// Απευθείας Ανάθεση
//			ΔιαβιβαστικόΔαπάνης,
//			Εξώφυλλο,
//			ΦύλλοΚαταχώρησης,
//			Υποφάκελος,
...
//			ΒεβαίωσηΜηΧρέωσηςΥλικών,
//			Υποφάκελος,
//			ΑπόφασηΑπευθείαςΑνάθεσηςMεΑΔΑΜστοΚΥΜΔΗΣ,
//			ΥπεύθυνηΔήλωσηMηΧρησιμοποίησηςΑντιπροσώπουΕταιρίαςΑξκουΕΔ,
