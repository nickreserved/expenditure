...
?>
προέβη στην αποσφράγιση και αξιολόγηση των προσφορών που κατατέθηκαν στο πλαίσιο διενέργειας <?=inflectPhrase(get_tender_type($tender), 1)?>, που προκηρύχθηκε με την <?=$tender['Διακήρυξη Διαγωνισμού']['Ταυτότητα']?> για <?=$per_tender['Κατηγορία']?>.\par
<?php }
...
function technical_offer_unseal_reports() {
	...
	foreach($data['Διαγωνισμοί'] as $per_tender)
		...
		else trigger_error('Για αποσφράγιση σε 2 φάσεις, σε συνοπτικό διαγωνισμό, πρέπει να τεθεί το πεδίο <b>Χρόνος Αποσφράγισης Οικονομικών Προσφορών</b>');
}
