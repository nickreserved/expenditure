...
\b\line ΠΡΟΣ:<? foreach($to as $v) echo '\tab ' . chk($v) . '\line'; ?>
\line ΚΟΙΝ:
<?
...
?>
\cell
<?=chk(toUppercase($data['Μονάδα']))?>\line <?=chk(toUppercase($data['Γραφείο']))?>\line\b0 Τηλ (Εσωτ.) <?=chk($data['ΕσωτερικόΤηλέφωνο'])?>\line
<?
	if (!$draft)
