...
?>
1.\tab Σας υποβάλλουμε συνημμένα, για τεχνοοικονομικό έλεγχο, φάκελο γενόμενης δαπάνης που αφορά «<?=rtf($data['Τίτλος'])?>» ύψους <?=euro($data['Τιμές']['Καταλογιστέο'])?>, ΕΦ <?=rtf($data['ΕΦ'])?>, ΑΛΕ <?=rtf($data['ΑΛΕ'])?> και απόφαση ανάληψης υποχρέωσης το σχετικό.\par
