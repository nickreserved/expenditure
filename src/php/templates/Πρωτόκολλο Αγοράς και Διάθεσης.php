...
που συγκροτήθηκε με την \ul <?=chk_order($data['ΔγηΑνάθεσης'])?>\ul0  προέβη στην αγορά και διάθεση των παρακάτω υλικών τα οποία και παρέδωσε στον Αξκο Έργου <?=man_ext($data['ΑξκοςΈργου'], 2)?>.\par\par
