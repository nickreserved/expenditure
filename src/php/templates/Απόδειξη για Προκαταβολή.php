...
\pard\plain\qj Ο υπογεγραμμένος <?=man_ext($data['ΑξκοςΈργου'], 0)?> έλαβα <?=euro2str($data['Προκαταβολή'])?> (<?=euro($data['Προκαταβολή'])?>), για «<?=chk($data['Τίτλος'])?>» κατόπιν της δγης <?=chk_order($data['ΔγηΔιάθεσης'])?> και <?=chk_order($data['ΔγηΑνάθεσης'])?> οι οποίες επισυνάπτονται.\par
\qr <?=now()?>\par
...
\pard\plain\qj Ο υπογεγραμμένος <?=man_ext($data['ΑξκοςΈργου'], 0)?>, εξουσιοδοτώ τον . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . να παραλάβει <?=euro2str($data['Προκαταβολή'])?> (<?=euro($data['Προκαταβολή'])?>), για «<?=chk($data['Τίτλος'])?>».\par
\qr <?=now()?>\par
...
$draft = false;
require('Δγη Συγκρότησης Επιτροπών.php');
?>