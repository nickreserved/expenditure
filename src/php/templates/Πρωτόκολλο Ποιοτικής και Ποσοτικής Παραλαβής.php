...
\pard\plain\b\qr <?=chk(toUppercase($data['Μονάδα']))?>\par\par
\fs24\ul\qc ΠΡΩΤΟΚΟΛΛΟ\line ΠΟΙΟΤΙΚΗΣ ΚΑΙ ΠΟΣΟΤΙΚΗΣ ΠΑΡΑΛΑΒΗΣ\par\par
...
που συγκροτήθηκε με την \ul <?=chk_order($data['ΔγηΑνάθεσης'])?>\ul0  προέβη στην ποιοτική και ποσοτική παραλαβή των παρακάτω <?=$bills_buy ? 'υλικών' . ($bills_contract ? ' και ' : '') : ''?><?=$bills_contract ? 'εργασιών' : ''?> που βρήκε σε άριστη κατάσταση και παρέδωσε στον Αξκο Έργου <?=man_ext($data['ΑξκοςΈργου'], 2)?>.\par\par
