...
<?=preOrder(!$draft || isset($data['ΔγηΔιακήρυξης']) ? $data['ΔγηΔιακήρυξης'] : null, getNewspapers($data['Εφημερίδες']), array(null), $draft, 'Ένα (-1-)')?>
<?=subjectOrder('Διακήρυξη Διαγωνισμού', array($data['ΔγηΔιάθεσης']))?>
...
Ανακοινώνεται ότι τις <?=chk($a[1])?> και ώρα <?=chk($a[0])?> θα διενεργηθεί Δημόσιος Διαγωνισμός με ενσφράγιστες προσφορές, <?=chk($data['ΤόποςΔιαγωνισμού'])?>, για <?=chk($data['ΘέμαΔιαγωνισμού'])?>.\par\par
Πληροφορίες καθημερινά στο τηλέφωνο <?=chk($data['Τηλέφωνο'])?>.\par
