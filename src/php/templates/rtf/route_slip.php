...
<? if ($prereport) { ?>
\tab\b 1.\b0\tab Υποβάλλεται συνημμένα έκθεση απαιτούμενης δαπάνης που αφορά «<?=chk($data['Τίτλος'])?> <?=euro($data['Ποσό'])?>».\par\par
<? } else { ?>
\tab\b 1.\b0\tab Υποβάλλεται συνημμένα φάκελος γενόμενης δαπάνης που αφορά «<?=chk($data['Τίτλος'])?> <?=euro($data['Ποσό'])?>», για τεχνοοικονομικό έλεγχο.\par\par
<? } ?>
