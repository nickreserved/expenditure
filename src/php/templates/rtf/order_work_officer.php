...
<? if (isset($data['ΗμερομηνίαΥποβολής'])) {?>\tab\b 3.\b0\tab Φάκελος γενομένης δαπάνης μαζί μα τα υπόλοιπα δικαιολογητικά να υποβληθούν μέχρι <?=chk_date($data['ΗμερομηνίαΥποβολής'])?>.\par\par<? } ?>
