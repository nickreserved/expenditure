...
\tab\b 1.\b0\tab Έχοντας υπ' οψην το σχετικό βάση του οποίου διατέθηκαν <?=euro2str($data['Ποσό'])?> (<?=euro($data['Ποσό'])?>) για «<?=chk($data['Τίτλος'])?>»\par
...
\tab\b 2.\b0\tab Η δαπάνη υπόκειται στις νόμιμες κρατήσεις.\par\par
<? if (isset($data['ΗμερομηνίαΥποβολής'])) {?>\tab\b 3.\b0\tab Απολογισμός γενομένης δαπάνης μαζί μα τα υπόλοιπα δικαιολογητικά να υποβληθούν μέχρι <?=chk_date($data['ΗμερομηνίαΥποβολής'])?>.\par\par<? } ?>
