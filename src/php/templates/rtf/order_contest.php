...
\tab 3.\tab Ο διαγωνισμός θα γίνει <?=$a || isset($data['ΏραΔιαγωνισμού'], $data['ΤόποςΔιαγωνισμού']) ? 'τις ' . chk_datetime($data['ΏραΔιαγωνισμού']) . ', ' . chk($data['ΤόποςΔιαγωνισμού']) : 'με περιφορά'?>.\par\par
