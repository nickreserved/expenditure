...
\tab 1.\tab Έχοντας υπ' όψιν το παραπάνω σχετικό βάση του οποίου διατέθηκαν στη Μονάδα <?=euro2str($data['Ποσό'])?> (<?=euro($data['Ποσό'])?>), για «<?=chk($data['Τίτλος'])?>»\par\par
...
'<? }
$count = 3;
if (isset($data['ΗμερομηνίαΥποβολής'])) {?>\tab <?=$count++?>.\tab Φάκελος γενομένης δαπάνης μαζί μα τα υπόλοιπα δικαιολογητικά να υποβληθούν μέχρι <?=chk_date($data['ΗμερομηνίαΥποβολής'])?>.\par\par<? }
