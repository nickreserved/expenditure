...
\pard\plain\li5953\box\brdrs\brdrw1\brsp170\tqdec\tx9922

\b ÊÁÔÁËÏÃÉÓÔÅÏ\tab <?=euro($bills_info['Êáôáëïãéóôİï'])?>\par
ĞËÇÑÙÔÅÏ\tab <?=euro($bills_info['Ğëçñùôİï'])?>\par
ÕĞÏËÏÉĞÏ ĞËÇÑÙÔÅÏ\tab <?=euro($bills_info['ÕğüëïéğïĞëçñùôİï'])?>\par\par
ÖÅ\tab <?=euro($bills_info['ÖÅÓåÅõñş'])?>\par\par
ÊÑÁÔÇÓÅÉÓ\tab <?=euro($a['Óıíïëï'], true)?>\par\b0\tx6520\tqdec\tx9922
<?
	foreach($a as $k => $v)
		if ($k != 'Óıíïëï')
