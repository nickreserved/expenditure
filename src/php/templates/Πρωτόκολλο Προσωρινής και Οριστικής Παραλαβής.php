...
\fs24\ul\qc ΠΡΩΤΟΚΟΛΛΟ\line ΠΡΟΣΩΡΙΝΗΣ ΚΑΙ ΟΡΙΣΤΙΚΗΣ ΠΑΡΑΛΑΒΗΣ\par\par
\pard\plain\tx567\tx1134\qj
\tab Οι υπογεγραμμένοι:\par
...
\pard\plain\qr\par <?=chk($data['Πόλη']) . ', ' . $data['ΗμερομηνίαΠροσωρινήςΟριστικήςΠαραλαβής']?>\par
