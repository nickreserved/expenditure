...
\pard\plain\qr <?=rtf($data['Σχηματισμός'])?>\line <?=rtf($data['Μονάδα'])?>\par
\pard\plain\sb240\sa240\qc{\b ΒΕΒΑΙΩΣΗ ΜΗ ΧΡΕΩΣΗΣ ΥΛΙΚΩΝ}\par
\pard\plain\sa240\qj Βεβαιώνεται η αγορά, παραλαβή, μη χρέωση και διάθεση για ικανοποίηση άμεσων αναγκών <?=rtf(article(gender($data['Μονάδα Πλήρες']), 1) . ' ' . inflectPhrase($data['Μονάδα Πλήρες'], 1))?>, των αναγραφόμενων στ<?=$c?> υπ' αριθμόν <?=get_names_key($invoices, 'Τιμολόγιο')?> τιμολόγι<?=$c?> προμήθειας σύμφωνα με την Φ.092/235631/9 Αυγ 1982 Απόφαση ΥΦΕΘΑ και Φ.600.9/12/601600/Σ.129/13 Ιαν 2005/ΓΕΣ/ΔΟΙ/3γ.\par
\pard\plain\qr\sa240 <?=rtf($data['Έδρα']) . ', ' . strftime('%d %b %y', get_newer_timestamp($invoices))?>\par
