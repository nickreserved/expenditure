...
που συγκροτήθηκε με την \ul <?=chk_order($data['ΔγηΑνάθεσης'])?>\ul0  προέβη στην ποιοτική και ποσοτική παραλαβή των παρακάτω υλικών και/ή εργασιών τα οποία βρήκε σε άριστη κατάσταση και τα οποία παρέδωσε στον Αξκο Έργου <?=man_ext($data['ΑξκοςΈργου'], 2)?>.\par\par
