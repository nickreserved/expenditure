...
if (!strpos($data['ΤύποςΔαπάνης'], 'Εργοληπτική Επιχείρηση'))
	trigger_error('Βεβαίωση Περάτωσης του Έργου χρησιμοποιείται μόνο για ανάθεση Έργου σε Εργολαβικές Επιχειρήσεις', E_USER_ERROR);
?>
...
\tab Σήμερα την <?=$data['ΗμερομηνίαΠροσωρινήςΟριστικήςΠαραλαβής']?> η επιτροπή προσωρινής και οριστικής παραλαβής αποτελούμενοι από τους:\par
...
που συγκροτήθηκε με την \ul <?=chk_order($data['ΔγηΠροσωρινήςΟριστικήςΠαραλαβής'])?>\ul0 , μεταβόντες σήμερα επί τόπου του έργου «<?=$data['Έργο']?>» (<?=chk($data['ΠεριοχήΈργου'])?>), κατόπιν προσκλήσεως του επιβλέποντος Αξκου <?=man_ext($data['ΑξκοςΈργου'], 1)?> παρέλαβαν το παραπάνω έργο το οποίο βρήκαν ολοκληρωμένο.\par\par
