...
\sa113\qc{\fs28\ul ΠΡΑΚΤΙΚΟ <?=$a ? 'ΔΗΜΟΣΙΟΥ' : 'ΠΡΟΧΕΙΡΟΥ'?> ΔΙΑΓΩΝΙΣΜΟΥ\par}
...
\fs28\ul\qc ΠΡΟΔΙΑΓΡΑΦΕΣ ΚΑΙ ΟΡΟΙ ΔΙΑΓΩΝΙΣΜΟΥ\par\par
...
\pard\plain\b <?=chk(toUppercase($data['Μονάδα']))?>\par\par
\fs28\ul\qc ΠΑΡΑΤΗΡΗΣΕΙΣ ΔΙΑΓΩΝΙΖΟΜΕΝΩΝ\par\par
...
\pard\plain\b <?=chk(toUppercase($data['Μονάδα']))?>\par\par
\fs28\ul\qc ΠΡΑΞΗ ΕΠΙΤΡΟΠΗΣ ΔΙΕΝΕΡΓΕΙΑΣ ΔΙΑΓΩΝΙΣΜΟΥ\par\par
...
\pard\plain\fs28\par\par\b\ul\qc ΠΡΑΞΗ ΕΠΙΤΡΟΠΗΣ ΠΑΡΑΛΑΒΩΝ\par\par
