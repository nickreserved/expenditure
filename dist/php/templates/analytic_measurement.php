...
\pard\plain\tx567\tx1134\tx1701\qj Σήμερα την <?=$data['ΗμερομηνίαΑφανώνΕργασιών']?> ο επιβλέπων του έργου «<?=$data['Έργο']?>» (<?=chk($data['ΠεριοχήΈργου'])?>), <?=man_ext($data['ΑξκοςΈργου'], 0)?> πραγματοποίησε την αναλυτική επιμέτρηση όλων των εργασιών που εκτελέστηκαν απολογιστικά όπως παρακάτω:\par
<?
$count = 0;
