...
'<? }
$count = 3;
if (isset($data['ΗμερομηνίαΥποβολής'])) {?>\tab\b <?=$count++?>.\b0\tab Απολογισμός γενομένης δαπάνης μαζί μα τα υπόλοιπα δικαιολογητικά να υποβληθούν μέχρι <?=chk_date($data['ΗμερομηνίαΥποβολής'])?>.\par\par<? }
