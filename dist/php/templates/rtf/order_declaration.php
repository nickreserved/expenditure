...
\tab\b 1.\b0\tab Παρακαλούμε όπως δημοσιεύσετε στην εφημερίδα σας την συνημμένη διακήρυξη.\par
...
\tab\b 4.\b0\tab Ο τίτλος της Μονάδας στο τέλος της διακήρυξης δε θα υπερβαίνει τον ένα (-1-) στίχο και τρία (-3-) χιλιοστά.\par
